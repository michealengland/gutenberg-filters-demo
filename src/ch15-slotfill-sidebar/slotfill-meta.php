<?php
/**
 * Register the metafield that the slotfill uses to save data.
 *
 * in the console you can locate with wp.data.select( 'core/editor' ).getCurrentPost().meta;
 * This will display the gfd_select_meta object.
 *
 * @link https://developer.wordpress.org/block-editor/tutorials/plugin-sidebar-0/plugin-sidebar-3-register-meta/
 */

// function gfd_register_editor_meta() {
// 	/**
// 	 * Register a meta field across all post types.
// 	 *
// 	 * @link https://developer.wordpress.org/reference/functions/register_post_meta/
// 	 */
// 	register_post_meta( '', 'gfd_select_meta', array(
// 		'show_in_rest' => true,
// 		'single' => true,
// 		'type' => 'string',
// 	) );
...
// 	) );
// }
// add_action('init', 'gfd_register_editor_meta');
